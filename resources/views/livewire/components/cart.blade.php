    ...
    <div class="absolute inset-x-0 top-auto z-50 w-screen max-w-sm px-6 py-8 mx-auto mt-4 bg-white border border-gray-100 shadow-xl sm:left-auto rounded-xl"
                                    ...
                                    <div class="flex py-4"
                                        ...
                                        <div class="flex-1 ml-4">
                                            ...
                                            <div class="flex items-center mt-2">
                                                ...
                                                <p  class="ml-2 text-xs">Quantity: {{ $line['quantity'] }}</p>
        ...
        @if ($this->cart)
            <div class="mt-4 space-y-4 text-center">
                ...
                <a class="block w-full p-3 text-sm font-medium text-center text-white bg-green-600 rounded-lg hover:bg-green-500 mt-2"
                   href="{{ route('checkoutnew.view') }}"
                   wire:navigate
                >
                    Checkout (Custom Stripe)
                </a>
