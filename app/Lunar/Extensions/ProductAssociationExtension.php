...
class ManageProductAssociations extends BaseManageRelatedRecords
{
    ...
    {
        return __('Product Associations');
    }
            ...
            ->schema([
                Forms\Components\Select::make('product_target_id')
                    ...
                    ->getSearchResultsUsing(static function (Forms\Components\Select $component, string $search): array {
                        // Get all products and filter in PHP to avoid database-specific JSON functions
                        return app(Product::modelClass())
                            ->get()
                            ->filter(function (ProductContract $record) use ($search) {
